...
(function () {
  ...
  Annotator.Plugin.Touch = (function (_super) {
    ...
    Touch.prototype.template =
      ...
      _t("Create Note") +
      '</a>\n<a class="annotator-button annotator-touch-toggle" data-state="off">' +
      _t("Start Annotating") +
      "</a>\n  </div>\n</div>";
    ...
    Touch.prototype._setupAnnotatorEvents = function () {
      ...
      return this.annotator.viewer.on(
        "hide",
        (function (_this) {
          return function () {
            return _this.utils.nextTick(function () {
    ...
    Touch.prototype._onHighlightTap = function (event) {
      ...
      clickable = jQuery(event.currentTarget)
        .parents()
        .filter(function () {
  ...
  Annotator.Plugin.Touch.Editor = (function (_super) {
    ...
    Editor.prototype.events = { click: "_onOverlayTap", ".annotator-save tap": "_onSubmit", ".annotator-cancel tap": "_onCancel", ".annotator-quote-toggle tap": "_onExpandTap" };
