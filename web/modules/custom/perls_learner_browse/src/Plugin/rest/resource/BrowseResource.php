...
/**
 * Provides a resource for returning relevant content for the current user.
 *
 * @RestResource(
 *   id = "browse_resource",
 *   label = @Translation("Relevant content"),
 *   uri_paths = {
 *     "canonical" = "/api/browse"
 *   }
 * )
 */
class BrowseResource extends ResourceBase {
