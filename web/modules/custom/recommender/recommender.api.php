 ...
 * \Drupal\recommender\Annotation\RecommendationEngine can
 * be altered here,
 ...
 */
function hook_recommender_engine_info_alter(array &$re_info) {
 ...
 */
function hook_recommender_recommendations_alter(array &$recommendations) {
