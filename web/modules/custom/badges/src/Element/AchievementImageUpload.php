...
namespace Drupal\badges\Element;

use Drupal\Core\Form\FormStateInterface;
use Drupal\file\Element\ManagedFile;

/**
 * Managed image FAPI element.
 *
 * @FormElement("achievement_image_upload")
 * @see https://drupal.stackexchange.com/a/245496
 */
class AchievementImageUpload extends ManagedFile {
  ...
  public static function processManagedFile(&$element, FormStateInterface $form_state, &$complete_form) {
    ...
    $element['#upload_validators'] += [
      ...
      'file_validate_extensions' => [
        implode(' ', $image_factory->getSupportedExtensions()),
      ],
    ];
