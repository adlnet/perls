 ...
 *
 * @Action(
 *   id = "badges_remove_badge",
 *   label = @Translation("Revoke a badge from users"),
 *   type = "user",
 *   confirm = FALSE
 * )
 */
class RemoveBadgeAction extends ViewsBulkOperationsActionBase implements PluginFormInterface, ContainerFactoryPluginInterface {
  ...
  /**
   * Constructor for Remove Badge Action.
   */
  ...
  public function execute($user = NULL) {
    ...
    $this->badgeService->revokeBadge($user, $this->configuration['badge_type']);
    return $this->t('Removed badge @badge from @user.',
    [
