...
/**
 * Provides a form for deleting push notification Token entities.
 *
 * @ingroup notifications
 */
class PushNotificationTokenDeleteForm extends ContentEntityConfirmFormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $form_state->setRedirectUrl(new Url('entity.push_notification_token.collection'));
  }
